  ...
  return (
    <div className="flex justify-center items-center h-[100vh] bg-dark-blue-main">
      <div className="bg-dark-blue-card p-6 rounded-lg w-80 text-white h-[93vh]">
        <img src="public/Rectangle Copy.png" alt="Equilibrium" className="w-full rounded-lg mb-6" />
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center">
            <img src="public/Combined Shape.png" alt="Ethereum" className="w-4 h-4 mr-2" />
            <span>0.041 ETH</span>
          </div>
          <div className="flex items-center">
            <img src="public/Clock.png" alt="Clock" className="w-4 h-4 mr-2" />
            <span>3 days left</span>
          </div>
        </div>
        <div className="flex items-center border-t border-dark-blue-line pt-4">
          <img src="public/Oval (6).png" alt="Avatar" className="w-8 h-8 rounded-full mr-4" />
